...
export const handler: FileHandler = {
  ...
  canEdit: true,
  Viewer: (props: { file: FileTab; onSave?: (fileId: string, buffer: ArrayBuffer) => void }) => <TextEditor {...props} readOnly={true} />,
  Editor: (props: { file: FileTab; onSave: (fileId: string, buffer: ArrayBuffer) => void }) => <TextEditor {...props} readOnly={false} />,
};
